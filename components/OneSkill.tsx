...
export default function OneSkill({ skill, directionLeft }: Props) {
  return (
    <div className="group relative flex cursor-pointer">
      ...
      <div className="absolute opacity-0 group-hover:opacity-80 transition duration-300 ease-in-out group-hover:bg-white h-[5.5rem] w-[5.5rem]  md:h-32 md:w-32 rounded-full z-0">
